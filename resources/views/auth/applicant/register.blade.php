...
@push('title')
    <title>Đăng ký | FindWork</title>
@endpush
@push('css')
    <link rel="stylesheet" href="{{ asset('css/auth/applicant/register.css') }}">
@endpush
@section('content')
                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h4 class="mt-1 mb-5 pb-1">Đăng ký tài khoản FindWork</h4>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('applicant.register') }}">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            <p class="mb-0 me-2 mr-1">Đã có tài khoản?</p>
                                            <a href="{{ route('applicant.show-login-form') }}" type="button"
