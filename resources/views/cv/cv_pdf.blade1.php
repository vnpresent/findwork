...
@section('content')
    @csrf
    <div class="container" style="background: #fffdc9">
            ...
            <div class="col-6 ">
                    ...
                    @foreach((array)$cv['work_experience'] as $work_experience)
                        <div class="input-item border border-light pl-2">
                            <div class="form-group row mt-3">
                                ...
                                <input class="form-control-plaintext col-2" type="text" name="work_experience[0][from]"
                                       disabled
                                       value="{{ $work_experience['from'] }}" placeholder="Bắt đầu">
                                <input class="form-control-plaintext col-2" type="text" name="work_experience[0][end]"
                                       disabled
                                       value="{{ $work_experience['end'] }}" placeholder="Kết thúc">
                            </div>
                            <div class="form-group row">
                                <input class="form-control-plaintext col-5" type="text" name="work_experience[0][name]"
                                       disabled
                ...
                <section class="activities">
                    ...
                    @foreach((array)$cv['activities'] as $activitie)
                        <div class="input-item border border-light pl-2">
                            <div class="form-group row mt-3">
                                <input class="form-control-plaintext col-2" type="text" name="activities[0][position]"
                                       disabled
                ...
                <section class="certifications">
                    ...
                    @foreach((array)$cv['certifications'] as $certification)
                        <div class="input-item border border-light pl-2">
                            <div class="form-group row mt-3">
                                <input class="form-control-plaintext col-2" type="text" name="certifications[0][time]"
                                       disabled
                                       value="{{ $certification['time'] }}" placeholder="Thời gian">
                            </div>
                            <div class="form-group row">
                                <input class="form-control-plaintext col-5" type="text" name="certifications[0][name]"
                                       disabled
                ...
                <section class="profile">
                    ...
                    <div class="input-item border border-light pl-2">
                        ...
                        <div class="input-group col-5">
                            ...
                            <input type="text" class="form-control-plaintext" value="{{ $cv['profile']['address'] }}"
                                   disabled
                                   placeholder="Địa chỉ"
                    ...
                    @foreach((array)$cv['skills'] as $skill)
                        <div class="input-item border border-light skill col-6 pb-2 mt-2 pl-2">
                            <div class="input-group col-12 skill-input mt-3">
                                <input type="text" class="form-control-plaintext font-weight-bold" value="{{ $skill['name'] }}" disabled
                                       name="skills[0][name]"
                                       placeholder="Kỹ năng">
                            ...
                            <div class="form-group col-12">
                                <textarea class="textarea-autosize form-control-plaintext" name="skills[0][description]" disabled
                                          rows="1" id=""
