...
@endpush
@section('content')
    <form method="post" action="{{ route('applicant.update-cv',['id'=>$cv['id']]) }}">
        @csrf
        <div class="container">
            <div class="col-10 mx-auto" style="background: #fafafa">
                ...
                <section class="profile mt-5">
                    <div class="col-3 mx-auto">
                        <input class="form-control-plaintext text-center" type="text" name="name"
                               value="{{ $cv['name'] }}"
                               placeholder="Tên CV">
                    </div>
                </section>
                ...
                <div class="row">
                    <div class="col-6 pl-5">
                        <section class="work_experience">
                            ...
                            @else
                                @foreach($cv['work_experience'] as $work_experience)
                                    <div class="input-item border border-light pl-2">
                                        <div class="type-icon position-absolute justify-content-center ml-5 d-none"
                                             style="z-index: 1;">
                                            <i class="add-work_experience fa fa-plus-circle">Thêm</i>
                                        ...
                                        <div class="form-group row">
                                            <input class="form-control-plaintext col-5" type="text"
                                                   name="work_experience[{{ $loop->index }}][name]"
                                                   value="{{ $work_experience['name'] }}" placeholder="Tên công ty">
                                        </div>
                                        <div class="form-group row">
                                <textarea class="textarea-autosize form-control-plaintext col-7" rows="1"
                                          name="work_experience[{{ $loop->index }}][description]" id=""
                            ...
                            @else
                                @foreach($cv['education'] as $education)
                                    <div class="input-item border border-light pl-2">
                                        ...
                                        <div class="form-group row">
                                            <input class="form-control-plaintext col-5" type="text"
                                                   name="education[{{ $loop->index }}][school]"
                                                   value="{{ $education['school'] }}"
                                                   placeholder="Trường">
                                        </div>
                                        <div class="form-group row">
                            <textarea class="textarea-autosize form-control-plaintext col-7" rows="1"
                                      name="education[{{ $loop->index }}][description]" id=""
                        ...
                        <section class="activities">
                            ...
                            @else
                                @foreach($cv['activities'] as $activities)
                                    <div class="input-item border border-light pl-2">
                                        <div class="type-icon position-absolute justify-content-center ml-5 d-none"
                                             style="z-index: 1;">
                                            <i class="add-activities fa fa-plus-circle">Thêm</i>
                                        ...
                                        <div class="form-group row">
                                            <input class="form-control-plaintext col-5" type="text"
                                                   name="activities[{{ $loop->index }}][name]"
                                                   value="{{ $activities['name'] }}"
                                                   placeholder="Tên tổ chức">
                                        </div>
                                        <div class="form-group row">
                            <textarea class="textarea-autosize form-control-plaintext col-7" rows="1"
                                      name="activities[{{ $loop->index }}][description]" id=""
                                      placeholder="Mô tả chi tiết hoạt động">{{ $activities['description'] }}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            @endif
                        ...
                        <section class="certifications">
                            ...
                            @else
                                @foreach($cv['certifications'] as $certifications)
                                    <div class="input-item border border-light pl-2">
                                        <div class="type-icon position-absolute justify-content-center ml-5 d-none"
                                             style="z-index: 1;">
                                            <i class="add-certifications fa fa-plus-circle">Thêm</i>
                                        ...
                                        <div class="form-group row">
                                            <input class="form-control-plaintext col-5" type="text"
                                                   name="certifications[{{ $loop->index }}][name]"
                            ...
                            @else
                                @foreach($cv['skills'] as $skill)
                                    <div class="input-item border border-light skill col-6 pb-2 mt-2 pl-2">
                                        ...
                                        <textarea class="textarea-autosize form-control-plaintext mb-0"
                                                  name="skills[{{ $loop->index }}][description]"
                                                  rows="1" id=""
                ...
                <div class="form-group col-4 mx-auto text-center">
                    ...
                    <a href="{{ route('applicant.my-cvs-form') }}" type="button" class="btn btn-secondary">Thoát</a>
                </div>
            </div>
        </div>
    </form>
...
@push('js')
    ...
    <script>
        window.skill_index = {{ $cv['skills']?count($cv['skills']):1 }};
        window.work_experience_index = {{ $cv['work_experience']?count($cv['work_experience']):1 }};
        window.education_index = {{ $cv['education']?count($cv['education']):1 }};
        window.activities_index = {{ $cv['activities']?count($cv['activities']):1 }};
        window.certifications_index = {{ $cv['certifications']?count($cv['certifications']):1 }};
